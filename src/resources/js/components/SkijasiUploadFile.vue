<template>
  <vs-col :vs-lg="size" vs-xs="12" class="skijasi-upload-file__container">
    <vs-input
      :label="label"
    ...
    <input
      type="file"
      class="skijasi-upload-file__input--hidden"
      ref="file"
    ...
    <div v-if="alert">
      <div v-if="$helper.isArray(alert)">
        <span
          class="skijasi-upload-file__input--error"
      ...
      <div v-else>
        <span class="skijasi-upload-file__input--error" v-html="alert"></span>
      </div>
    </div>
    <vs-row v-if="hasValue">
      <vs-col vs-lg="4" vs-sm="12">
        <div class="skijasi-upload-file__preview">
          <vs-button
            class="skijasi-upload-file__remove-button"
            color="danger"
            icon="close"
            @click="$emit('input', null)"
          />
          <div class="skijasi-upload-file__preview-text">
            <a target="_blank" :href="$api.skijasiFile.download(value)">
    ...
    <div
      class="skijasi-upload-file__popup-dialog"
      tabindex="0"
      v-if="showFileManager"
    >
      <div class="skijasi-upload-file__popup-container">
        <div class="skijasi-upload-file__popup--top-bar">
          <h3>{{ $t("fileManager.title") }}</h3>
          <vs-spacer />
          <vs-button
            color="danger"
            type="relief"
            class="skijasi-upload-file__popup-button--delete"
            v-if="model"
        ...
        <ul class="skijasi-upload-file__popup--left-bar">
          <li
        ...
        <div class="skijasi-upload-file__popup--right-bar">
          <div
            class="skijasi-upload-file__popup-add-file"
          ...
          >
            <div
              :class="{
                ...
                'skijasi-upload-file__popup-file': true,
              }"
            >
              <vs-icon
                ...
                color="#06bbd3"
              ></vs-icon>
              <p class="skijasi-upload-file__popup-file-text">
                {{ file.name | truncate }}
              </p>
            </div>
          </div>
        ...
        <div class="skijasi-upload-file__popup--bottom-bar">
          <div class="skijasi-upload-file__popup-button--footer">
            <div>
              <vs-pagination
    ...
    <vs-popup
      ...
      class="skijasi-upload-file__popup-dialog--delete"
    >
      <p>{{ $t("action.delete.text") }}</p>
      <div class="skijasi-upload-file__popup-dialog-content--delete">
