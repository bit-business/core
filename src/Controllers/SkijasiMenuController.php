...
class SkijasiMenuController extends Controller
{
    ...
    public function readMenu(Request $request)
    {
        try {
            $request->validate([
                'menu_id' => ['required', 'exists:NadzorServera\Skijasi\Models\Menu,id'],
            ]);
            $menu = Menu::find($request->menu_id);
    ...
    public function readMenuItem(Request $request)
    {
        try {
            $request->validate([
                'menu_id'      => ['required', 'exists:NadzorServera\Skijasi\Models\Menu,id'],
                'menu_item_id' => ['required', 'exists:NadzorServera\Skijasi\Models\MenuItem,id'],
            ]);
    ...
    public function browseMenuItemByKey(Request $request)
    {
        try {
            $request->validate([
                'menu_key' => ['required', 'exists:NadzorServera\Skijasi\Models\Menu,key'],
            ]);
            $prefix = config('skijasi.database.prefix');
    ...
    public function addMenu(Request $request)
    {
        ...
        try {
            $request->validate([
                'key'          => ['required', 'unique:NadzorServera\Skijasi\Models\Menu'],
    ...
    public function editMenu(Request $request)
    {
        ...
        try {
            $request->validate([
                'menu_id'      => ['required', 'exists:NadzorServera\Skijasi\Models\Menu,id'],
                'key'          => ['required', "unique:NadzorServera\Skijasi\Models\Menu,key,{$request->menu_id}"],
                'display_name' => ['required'],
            ]);
