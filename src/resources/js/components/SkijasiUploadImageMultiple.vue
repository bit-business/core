<template>
  <vs-col
    :vs-lg="size"
    vs-xs="12"
    class="skijasi-upload-image-multiple__container"
  >
    <vs-input
      :label="label"
    ...
    <input
      type="file"
      class="skijasi-upload-image-multiple__input--hidden"
      ref="image"
    ...
    <div v-if="alert">
      <div v-if="$helper.isArray(alert)">
        <span
          class="skijasi-upload-image-multiple__input--error"
    ...
    <vs-row v-if="hasValue">
      <vs-col
        ...
        :key="index"
      >
        <div class="skijasi-upload-image-multiple__preview">
          <vs-button
            class="skijasi-upload-image-multiple__remove-button"
            color="danger"
            icon="close"
            @click="() => deleteSelectedImage(val)"
          />
          <img :src="val" class="skijasi-upload-image-multiple__preview-image" />
        </div>
      </vs-col>
    </vs-row>

    <div
      class="skijasi-upload-image-multiple__popup-dialog"
      tabindex="0"
      v-if="showFileManager"
    >
      <div class="skijasi-upload-image-multiple__popup-container">
        <div class="skijasi-upload-image-multiple__popup--top-bar">
          <h3>{{ $t("fileManager.title") }}</h3>
          <vs-spacer />
          <vs-button
            color="danger"
            type="relief"
            class="skijasi-upload-image-multiple__popup-button--delete"
        ...
        <ul class="skijasi-upload-image-multiple__popup--left-bar">
          <li
          ...
          <li
            :class="{
              ...
              'skijasi-upload-image-multiple__menu--disabled':
        ...
        <div
          class="skijasi-upload-image-multiple__popup--right-bar"
          v-if="getActiveTab !== 'url'"
        >
          <div
            class="skijasi-upload-image-multiple__popup-add-image"
          ...
          <img
            :class="{
              ...
              'skijasi-upload-image-multiple__popup-image': true,
            }"
        ...
        <div
          v-if="getActiveTab === 'url'"
          class="skijasi-upload-image-multiple__popup--right-bar skijasi-upload-image-multiple__popup--url-bar"
        >
          <vs-input
          ...
          <img
            ...
            @error="
              ...
              $closeLoader();
            "
            class="skijasi-upload-image-multiple__preview--small"
          />
        </div>

        <div class="skijasi-upload-image-multiple__popup--bottom-bar">
          <div class="skijasi-upload-image-multiple__popup-button--footer">
            ...
            <vs-button
              color="primary"
              type="relief"
              class="skijasi-upload-image-multiple__popup-button"
              @click="emitInput"
    ...
    <vs-popup
      ...
      class="skijasi-upload-image-multiple__popup-dialog--delete"
    >
      <p>{{ $t("action.delete.text") }}</p>
      <div class="skijasi-upload-image-multiple__popup-dialog-content--delete">
...
export default {
  name: "SkijasiUploadImageMultiple",
  props: {
    size: {
      type: String || Number,
      default: "12",
