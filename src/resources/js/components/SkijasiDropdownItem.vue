<template>
  <li
    ...
    class="skijasi-dropdown-item__container"
    @click="closeParent"
  ...
  >
    <router-link
      ...
      class="skijasi-dropdown-item__item--link"
      v-on="$listeners"
    >
      {{ $attrs.disabled }}
      <div class="skijasi-dropdown-item__item">
        <div>
          <vs-icon
            v-if="icon"
            :icon-pack="iconPack"
            :icon="icon"
            class="skijasi-dropdown-item__item--icon"
          ></vs-icon>
        </div>
        <div class="skijasi-dropdown-item__item--text">
          <slot />
        </div>
      </div>
    </router-link>
