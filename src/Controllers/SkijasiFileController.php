...
public function customUploadFilePoruke(Request $request)
{
    $file = $request->file('file');

    // Get the number of existing files in the directory
    $existingFilesCount = count(Storage::files('porukeslike'));
...
public function customUploadFileObradarobe(Request $request)
{
    $file = $request->file('file');

    // Get the number of existing files in the directory
    $existingFilesCount = count(Storage::files('obradarobe'));
