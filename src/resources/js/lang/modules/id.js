...
export default {
  ...
  keyIssue: {
    ...
    message:
      "Mohon maaf, Skijasi belum bisa digunakan dikarenakan ada issue pada lisensi anda",
    listTitle:
      "Berikut adalah beberapa masalah yang bisa terjadi pada lisensi:",
    licenseEmpty: "Lisensi Kosong",
    licenseEmptyDescription:
      "Anda belum memasukkan SKIJASI_LICENSE_KEY pada .env. Harap isi dahulu sebelum bisa menggunakan skijasi. Untuk petunjuk lebih lengkap, bisa di lihat disini.",
    licenseInvalid: "Lisensi Invalid",
    licenseInvalidDescription:
      "SKIJASI_LICENSE_KEY tidak diemukan. Harap pastikan sudah sama dengan yang anda dapatkan pada Skijasi Dashboard. Untuk petunjuk lebih lengkap, bisa di lihat disini.",
    licenseUsersExpired: "Masa Aktif Kadaluarsa",
    licenseUsersExpiredDescription:
      "Masa aktif anda sudah habis. Mohon untuk menambahkan masa aktif anda pada Skijasi Dashboard supaya license anda dapat digunakan kembali. Untuk petunjuk lebih lengkap, bisa di lihat disini.",
  },
  authorizationIssue: {
  ...
  database: {
    browse: {
      ...
      fieldNotSupport: {
        ...
        text: "Terdapat tipe data yang tidak didukung pada tabel, silahkan lihat tipe data yang didukung di dokumentasi Skijasi",
