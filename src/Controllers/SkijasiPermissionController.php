...
class SkijasiPermissionController extends Controller
{
    ...
    public function read(Request $request)
    {
        try {
            $request->validate([
                'id' => 'required|exists:NadzorServera\Skijasi\Models\Permission,id',
            ]);
    ...
    public function edit(Request $request)
    {
        ...
        try {
            $request->validate([
                'id' => [
                    'required',
                    'exists:NadzorServera\Skijasi\Models\Permission,id',
                ],
                'key'          => "required|unique:NadzorServera\Skijasi\Models\Permission,key,{$request->id}",
    ...
    public function add(Request $request)
    {
        ...
        try {
            $request->validate([
                'key'          => 'required|unique:NadzorServera\Skijasi\Models\Permission',
                'description'  => 'nullable',
                'always_allow' => 'required',
                'is_public'    => 'required',
            ]);
    ...
    public function delete(Request $request)
    {
        ...
        try {
            $request->validate([
                'id' => [
                    'required',
                    'exists:NadzorServera\Skijasi\Models\Permission',
                ],
            ]);
