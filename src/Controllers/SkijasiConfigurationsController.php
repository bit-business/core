...
class SkijasiConfigurationsController extends Controller
{
    use FileHandler;
    ...
    public function fetch(Request $request)
    {
        try {
            $request->validate([
                'key' => 'sometimes|required|exists:NadzorServera\Skijasi\Models\Configuration,key',
                'group' => 'sometimes|required|exists:NadzorServera\Skijasi\Models\Configuration,group',
            ]);
