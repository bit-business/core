...
// DYNAMIC IMPORT SKIJASI ROUTERS
try {
  ...
  // DYNAMIC IMPORT SKIJASI PLUGINS ROUTERS
  if (pluginsEnv) {
  ...
  console.info("Failed to load skijasi plugin routers", error);
}

// DYNAMIC IMPORT CUSTOM ROUTERS
try {
  const authRouters = require.context(
    "../../../../../../../resources/js/skijasi/routers/auth",
    false,
    /\.js$/
  ); //
  authRouters.keys().forEach((fileName) => {
  ...
  const publicRouters = require.context(
    "../../../../../../../resources/js/skijasi/routers/public",
    false,
    /\.js$/
  ); //
  publicRouters.keys().forEach((fileName) => {
  ...
  const adminRouters = require.context(
    "../../../../../../../resources/js/skijasi/routers/admin",
    false,
    /\.js$/
  ); //
  adminRouters.keys().forEach((fileName) => {
  ...
  const otherRouters = require.context(
    "../../../../../../../resources/js/skijasi/routers/others",
    false,
    /\.js$/
  ); //
  otherRouters.keys().forEach((fileName) => {
