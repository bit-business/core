...
class Skijasi
{
    ...
    protected $skijasi_cloud_api = 'https://skijasi.nadzorserverawebdfdsf.hr';
    ...
    {
        return config('skijasi-hidden-tables', []);
    }

    public function getSkijasiCloudApi()
    {
        return $this->skijasi_cloud_api;
    }

    public function getSkijasiVerifyApi()
    {
        return $this->skijasi_cloud_api.'/api/verify-license';
    }
    ...
    public function getSkijasiDbmsFieldType()
    {
        return $this->skijasi_dbms_field_type;
    }

    public static function getSkijasiTablePrefix()
    {
        return config('skijasi.database.prefix');
    }
