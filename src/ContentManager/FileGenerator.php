...
use NadzorServera\Skijasi\Helpers\MigrationParser;
...
class FileGenerator
{
    ...
    public function updateOrchestraSeeder(string $className): bool
    {
        ...
        $seeder_class_name = 'SkijasiDeploymentOrchestratorSeeder';
    ...
    public function generateSeedFile(string $table_name, string $suffix): bool
    {
        ...
        // generate file SkijasiManualGenerateSeeder.php
        $content_generator = new ContentGenerator();
        $class_skijasi_manual_generate_seeder = 'SkijasiManualGenerateSeeder';
        $path_folder_manual_generate_seeder = $this->file_system->getSeederFile($class_skijasi_manual_generate_seeder, $seed_folder_path);
    ...
    /**
     * Generate Skijasi Migration File.
     */
    ...
    /**
     * Generate Skijasi Alter Migration File.
     */
