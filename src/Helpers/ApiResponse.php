...
class ApiResponse
{
    ...
    {
        $response = [];
        $response['message'] = __('skijasi::api_response.200');
    ...
    public static function failed($error = null)
    {
        ...
        if ($error instanceof ValidationException) {
            $response['message'] = __('skijasi::api_response.400');
    ...
    {
        $response['message'] = $message ? $message : __('skijasi::api_response.401');
        $response['errors'] = null;
        $response['data'] = null;
    ...
    {
        $response['message'] = __('skijasi::api_response.403');
        $response['errors'] = null;
        $response['data'] = null;
    ...
    {
        $response['message'] = __('skijasi::api_response.503');
        $response['errors'] = null;
        $response['data'] = null;
    ...
    {
        $response['message'] = $message ?? __('skijasi::api_response.402');
        $response['errors'] = null;
        $response['data'] = null;
    ...
    {
        $response['message'] = $message ?? __('skijasi::api_response.412');
        $response['errors'] = null;
        $response['data'] = null;
