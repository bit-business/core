          ...
          <vs-row vs-justify="center" vs-align="center">
            <vs-col col-lg="12">
              <vs-table :data="databaseData.fields.modifiedFields">
                <template slot="thead">
                  <vs-th class="skijasi-table__no-wrap">
                  ...
                  <vs-th class="skijasi-table__no-wrap"></vs-th>
                </template>
            ...
            if (error.errors.code.indexOf("HY000") == 0) {
              this.$vs.notify({
                ...
                text: this.$t("database.edit.warning.fieldAttUnsigned", {
                  0: `<b><a href="https://skijasi-docs.nadzorserveraweb.hr/core-concept/database-management#create-relationship-table" target="_blank">${this.$t(
