<template>
  <vs-col
    :vs-lg="size"
    vs-xs="12"
    class="skijasi-upload-file-multiple__container"
  >
    <vs-input
      :label="label"
    ...
    <input
      type="file"
      class="skijasi-upload-file-multiple__input--hidden"
      ref="file"
    ...
    <div v-if="alert">
      <div v-if="$helper.isArray(alert)">
        <span
          class="skijasi-upload-file-multiple__input--error"
    ...
    <vs-row v-if="hasValue">
      <vs-col
        ...
        :key="index"
      >
        <div class="skijasi-upload-file-multiple__preview">
          <vs-button
            class="skijasi-upload-file-multiple__remove-button"
            color="danger"
            icon="close"
            @click="() => deleteSelectedFile(file)"
          />
          <div class="skijasi-upload-file-multiple__preview-text">
            <a target="_blank" :href="$api.skijasiFile.download(file)">
    ...
    <div
      class="skijasi-upload-file-multiple__popup-dialog"
      tabindex="0"
      v-if="showFileManager"
    >
      <div class="skijasi-upload-file-multiple__popup-container">
        <div class="skijasi-upload-file-multiple__popup--top-bar">
          <h3>{{ $t("fileManager.title") }}</h3>
          <vs-spacer />
          <vs-button
            color="danger"
            type="relief"
            class="skijasi-upload-file-multiple__popup-button--delete"
        ...
        <ul class="skijasi-upload-file-multiple__popup--left-bar">
          <li
        ...
        <div class="skijasi-upload-file-multiple__popup--right-bar">
          <div
            class="skijasi-upload-file-multiple__popup-add-file"
          ...
          <div
            :class="{
              ...
              'skijasi-upload-file-multiple__popup-file': true,
            }"
            v-for="(file, index) in files"
            :key="index"
            @click="selectFile(file.url)"
            class="skijasi-upload-file__popup-file-container"
          >
            <vs-icon
              ...
              color="#06bbd3"
            ></vs-icon>
            <p class="skijasi-upload-file-multiple__popup-file-text">
              {{ file.name | truncate }}
            </p>
          </div>
        </div>

        <div class="skijasi-upload-file-multiple__popup--bottom-bar">
          <div class="skijasi-upload-file-multiple__popup-button--footer">
            <div>
              <vs-pagination
            ...
            <vs-button
              ...
              @click="emitInput"
              :disabled="!model"
              class="skijasi-upload-file__popup-button"
            >
              {{ $t("button.submit") }}
            </vs-button>
            <vs-button
    ...
    <vs-popup
      ...
      class="skijasi-upload-file-multiple__popup-dialog--delete"
    >
      <p>{{ $t("action.delete.text") }}</p>
      <div class="skijasi-upload-file-multiple__popup-dialog-content--delete">
...
export default {
  name: "SkijasiUploadFileMultiple",
  props: {
    size: {
      type: String || Number,
      default: "12",
