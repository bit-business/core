...
class SkijasiApiConfigurationTest extends TestCase
{
    /**
    ...
    {
        $set_key_maintenance = config(['skijasi.skijasi_maintenance' => null]);
        $request_data = [
            'path' => '/skijasi-dashboard/login',
        ];

        $path_secret_login = config('skijasi.secret_login_prefix');
        $request_data_secret_login = [
            'path' => '/skijasi-dashboard/'.$path_secret_login,
        ];
    ...
    {
        $set_key_maintenance = config(['skijasi.skijasi_maintenance' => true]);
        $request_data = [
            'path' => '/skijasi-dashboard/login',
        ];
    ...
    {
        $set_key_maintenance = config(['skijasi.skijasi_maintenance' => false]);
        $request_data_login = [
            'path' => '/skijasi-dashboard/login',
        ];
