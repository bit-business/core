...
class CreateFirebaseCloudMessagesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create(config('skijasi.database.prefix').'firebase_cloud_messages', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists(config('skijasi.database.prefix').'firebase_cloud_messages');
    }
}
