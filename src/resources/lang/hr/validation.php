...
return [
    'auth' => [
        'invalid_credentials'  => 'Neispravan email ili šifra',
        'user_not_found'       => 'Korisnički profil ne postoji',
        'wrong_old_password'   => 'Neispravna stara šifra',
        'password_not_changes' => 'nova šifra mora biti drugačija od stare',
    ],
    'crud' => [
    ...
    'verification' => [
        'email_sended'               => 'Poruka za potvrdu poslana je na vašu e-poštu',
